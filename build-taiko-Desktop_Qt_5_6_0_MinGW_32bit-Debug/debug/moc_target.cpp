...
QT_MOC_LITERAL(1, 7, 10), // "rightPlace"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 10), // "wrongPalce"
QT_MOC_LITERAL(4, 30, 4) // "move"

    },
    "Target\0rightPlace\0\0wrongPalce\0move"
};
...
void Target::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rightPlace(); break;
        case 1: _t->wrongPalce(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Target::rightPlace)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Target::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Target::wrongPalce)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Target::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Target.data,
...
void *Target::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Target*>(this));
...
// SIGNAL 0
void Target::rightPlace()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Target::wrongPalce()
{
